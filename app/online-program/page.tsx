            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <p className="text-white/90">
                  The 59-Minute Training Program is a comprehensive system
                  designed to develop explosive speed, strength, and stability
                  for competitive athletes. Based on the same principles used
                  with elite athletes, this program delivers results in an
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <span className="bg-[#00BFFF] text-white text-sm px-2 py-1 rounded">
                    39% OFF
                  </span>
                </div>
                <Button
          ...
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-white/80 max-w-2xl mx-auto">
                A comprehensive training system designed for maximum results in
                minimum time.
              </p>
            </div>
              ...
              {[
                {
                  ...
                  icon: (
                    <CheckCircle className="h-10 w-10 mb-4 text-[#00BFFF]" />
                  )
                },
                {
                ...
                },
                {
                  ...
                  description:
                    "Detailed video demonstrations of each exercise with expert coaching cues.",
                ...
                },
                {
                  ...
                  description:
                    "PDF workout sheets and progress trackers to monitor your improvement.",
                  icon: <Download className="h-10 w-10 mb-4 text-[#00BFFF]" />
                },
                {
                  title: "Lifetime Access",
                  description:
                    "Purchase once and get unlimited access to all program materials and future updates.",
        ...
        <section className="w-full py-12 md:py-24 bg-[#010B60]">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-white/80 max-w-2xl mx-auto">
                Six essential components that work together to develop explosive
              ...
              {[
                {
                  ...
                  description:
                    "Unlock hip mobility to improve speed and prevent injuries.",
                  duration: "8 minutes"
                },
                {
                  number: "02",
                  ...
                  description:
                    "Prepare your body for optimal performance with targeted activation.",
                  duration: "10 minutes"
                },
                {
                  number: "03",
                  ...
                  description:
                    "Develop explosive power and balance with unilateral training.",
                  duration: "12 minutes"
                },
                {
                  number: "04",
                  ...
                  description:
                    "Build functional strength that translates directly to athletic movement.",
                  duration: "12 minutes"
                },
                {
                  number: "05",
                  ...
                  description:
                    "Strengthen your foundation for improved power transfer and injury prevention.",
                  duration: "10 minutes"
                },
                {
                  number: "06",
                  ...
                  description:
                    "Optimize recovery to maximize training adaptations and prevent soreness.",
                  duration: "7 minutes"
                }
              ].map((lesson, i) => (
                <div
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                ...
                <div className="pt-4">
                  ...
                  <Button
                    size="lg"
                    className="bg-[#00BFFF] hover:bg-[#00BFFF]/90 text-white font-medium px-8 mt-4"
                  >
                    Get Instant Access
                  </Button>
        ...
        <section className="w-full py-12 md:py-24 bg-[#02085C]">
          <div className="container px-4 md:px-6">
            <div className="text-center mb-12">
              ...
              <p className="text-white/80 max-w-2xl mx-auto">
                See what athletes are saying about the 59-Minute Training
                Program.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-5xl mx-auto">
              {[
                ...
                <div
                  key={i}
                  className="p-6 rounded-xl bg-[#030456] border border-[#010B60]"
                >
                  <div className="flex flex-col h-full">
                    <div className="text-[#00BFFF] text-4xl font-serif mb-4">
                      "
                    </div>
          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
              ...
              <p className="text-white/80">
                Join hundreds of athletes who have already elevated their game
                with the 59-Minute Training Program.
              </p>
